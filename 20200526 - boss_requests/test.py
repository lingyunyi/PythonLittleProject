...
city_dict = {'010000': '北京', '010100': '东城区', '010200': '西城区',
             ...
             361003: '马来西亚', 361004: '新加坡', 361005: '泰国', 361006: '菲律宾', 361007: '印度尼西亚', 361008: '斯里兰卡', 361009: '印度', 361010: '缅甸', 361011: '越南', 361012: '朝鲜', 361013: '哈萨克斯坦', 361014: '乌兹别克斯坦', 361015: '伊朗', 361016: '伊拉克', 361017: '阿富汗', 361018: '巴基斯坦', 361019: '土耳其', 361020: '科威特',
             361021: '沙特阿拉伯', 361022: '蒙古',
             361023: '孟加拉国', 362000: '欧洲', 362001: '英国', 362002: '法国', 362003: '德国', 362004: '意大利', 362005: '西班牙', 362006: '葡萄牙', 362007: '爱尔兰', 362008: '波兰', 362009: '挪威',
             362010: '瑞典', 362011: '芬兰', 362012: '奥地利', 362013: '乌克兰', 362014: '白俄罗斯', 362015: '保加利亚', 362016: '罗马尼亚', 362017: '匈牙利', 362018: '希腊', 362019: '俄罗斯', 362020: '瑞士', 362021: '丹麦', 362022: '比利时', 362023: '荷兰', 363000: '美洲', 363001: '美国', 363002: '加拿大', 363003: '墨西哥', 363004: '巴西',
             363005: '阿根廷', 363006: '智利', 363007: '秘鲁',
...
for i in range(len(big)):
    try:
        table.write(i, 0, big[i][0])
        table.write(i, 1, big[i][1])
    except:
        continue
book.save("城市代码表.xls")